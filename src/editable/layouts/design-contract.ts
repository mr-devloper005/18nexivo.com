...
export const editableRootStyle = {
  '--slot4-page-bg': '#f4f4f2',
  '--slot4-page-text': '#06181b',
  '--slot4-panel-bg': '#eeeeec',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#5f686b',
  '--slot4-soft-muted-text': '#778184',
  '--slot4-accent': '#ff604a',
  '--slot4-accent-fill': '#ff604a',
  '--slot4-accent-soft': '#ffe4de',
  '--slot4-dark-bg': '#001316',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#e8ecec',
  '--slot4-cream': '#f4f4f2',
  '--slot4-warm': '#ffffff',
  '--slot4-lavender': '#ff604a',
  '--slot4-gray': '#eef0ef',
  '--slot4-body-gradient': 'linear-gradient(180deg, #ffffff 0%, #f4f4f2 52%, #eef0ef 100%)',
} as CSSProperties
...
export const editableDesignContract = {
  shell: {
    ...
    section: 'mx-auto w-full max-w-[1296px] px-4 sm:px-6 lg:px-8',
  ...
  button: {
    primary: `inline-flex items-center justify-center gap-2 rounded-full bg-[var(--slot4-dark-bg)] px-7 py-3.5 text-xs font-black uppercase tracking-[0.08em] text-white transition hover:bg-[var(--slot4-accent-fill)]`,
    secondary: `inline-flex items-center justify-center gap-2 rounded-full border border-black/20 bg-white px-7 py-3.5 text-xs font-black uppercase tracking-[0.08em] text-black transition hover:bg-black hover:text-white`,
    accent: `inline-flex items-center justify-center gap-2 rounded-full bg-[var(--slot4-accent-fill)] px-7 py-3.5 text-xs font-black uppercase tracking-[0.08em] text-white transition hover:bg-black`,
  },
  media: {
...
export const aiLayoutRules = [
  ...
  'Use a media-distribution logistics style with coral accents, ink panels, white angled surfaces, compact containers, and fast-scanning cards.',
