...
const inputClass = 'h-[3.5rem] rounded-2xl border border-black/10 bg-white px-4 text-base font-bold text-black outline-none transition placeholder:text-black/35 focus:border-[var(--slot4-accent)]'
const buttonClass = 'inline-flex h-[3.5rem] items-center justify-center rounded-full bg-[var(--slot4-accent)] px-6 text-xs font-black uppercase tracking-[0.12em] text-white transition hover:bg-[#001316] disabled:opacity-60'
